    ...
    <div>
      {entriesWithBalance.length > 0 &&
        entriesWithBalance.map((group, index) => (
          <div
            key={index}
            className="rounded-xl p-4 shadow-md bg-white dark:bg-gray-800 mb-6 print:m-0 print:p-0 print:shadow-none print:w-full"
          >
            <h2 className="font-semibold mb-3 text-gray-800 dark:text-gray-100 text-lg print:text-base print:mb-1">
            ...
            <div className="overflow-auto max-h-[400px] print:overflow-visible print:max-h-fit print:text-xs">
              <table className="w-full border border-gray-300 dark:border-gray-600 text-sm print:text-xs print:w-full">
                <thead className="bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                  <tr 
                    className="border-t cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors print:hover:bg-transparent"
                  >
                    <th className="px-2 py-1 border print:p-0 print:border-black print:text-black">
                      Дата
                    </th>
                ...
                <tbody>
                  {mergeEntriesWithRunningBalance(group.entries).map(
                    (entry) => (
                      ...
                      >
                        <td className="px-2 py-1 border print:pl-1 print:border-black print:text-black">
                ...
                <tfoot className="bg-gray-200 dark:bg-gray-800 font-semibold">
                  <tr>
                    <td
                      colSpan={2}
                      className="px-2 py-1 border print:pl-1 print:border-black print:text-black"
                    >
                      Итого:
                    </td>
                    <td className="px-2 py-1 border print:pl-1 print:border-black print:text-black">
                    ...
                    <td className="px-2 py-1 border print:pl-1 print:border-black print:text-black">
                      {formatNumber(group.final_balance)}
                    </td>
                  </tr>
                </tfoot>
              </table>
