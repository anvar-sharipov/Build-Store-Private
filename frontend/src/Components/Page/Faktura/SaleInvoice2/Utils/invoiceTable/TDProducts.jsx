...
const TDProducts = ({ handleDeleteProduct, visibleColumns, printVisibleColumns, showNotification, productQuantityRefs, productListRefs, productInputRef, productPriceRefs }) => {
