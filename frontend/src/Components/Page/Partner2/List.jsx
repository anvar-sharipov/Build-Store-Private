            ...
            <motion.li
              ...
              className={`
                ...
                ${hoveredPartner === partner.id 
                  ? "shadow-lg transform hover:scale-[1.02] hover:shadow-xl" 
                  : "shadow-sm"
                }
                ...
                <div className="flex items-center gap-6">
                  ...
                  >
                    ...
                    <div className="text-lg font-bold text-gray-900 dark:text-white">
                      {formatNumber(partner.balance_usd)}
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="text-lg font-bold text-gray-900 dark:text-white">
                      {formatNumber(partner.balance_tmt)}
                    </div>
                  </motion.div>
        ...
        {Array.from({ length: totalPages }, (_, i) => i + 1).map((p, index) => (
          ...
          >
            {page === p && (
              <motion.div
                layoutId="activePage"
                className="absolute inset-0 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 -z-10"
