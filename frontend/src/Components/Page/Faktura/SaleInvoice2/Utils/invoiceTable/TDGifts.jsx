...
const td2 = "px-3 py-2 text-gray-700 dark:text-gray-300 text-right border border-black dark:border-gray-600 print:!text-black print:px-1 print:py-0.5";
      ...
      {values.gifts.map((product, index) => {
        ...
        return (
          <tr key={product.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors bg-green-50 dark:bg-green-900/20">
            ...
            <td className="px-3 py-2 font-semibold text-gray-700 dark:text-gray-300 text-left border border-black dark:border-gray-600 print:!text-black print:px-1 print:py-0.5">
              {product.name}
            </td>
            ...
            <td className="px-3 py-2 text-gray-700 dark:text-gray-300 text-left border border-black dark:border-gray-600 print:!text-black font-semibold">
            ...
            <td
              className={`px-3 py-2 border border-black dark:border-gray-600 ${visibleColumns.purchase ? "table-cell" : "hidden"} ${
            ...
            <td
              className={`px-3 py-2 border border-black dark:border-gray-600 ${visibleColumns.discount ? "table-cell" : "hidden"} ${
            ...
            <td className={`${td2} ${visibleColumns.weight ? "table-cell" : "hidden"} ${printVisibleColumns.weight ? "print:table-cell" : "print:hidden"}`}>{formatNumber(total_weight, 3)}</td>
            <td className={`${td2} ${visibleColumns.dimensions ? "table-cell" : "hidden"} ${printVisibleColumns.dimensions ? "print:table-cell" : "print:hidden"}`}>{formatNumber(total_length, 3)}</td>
            <td className={`${td2} ${visibleColumns.dimensions ? "table-cell" : "hidden"} ${printVisibleColumns.dimensions ? "print:table-cell" : "print:hidden"}`}>{formatNumber(total_width, 3)}</td>
            <td className={`${td2} ${visibleColumns.dimensions ? "table-cell" : "hidden"} ${printVisibleColumns.dimensions ? "print:table-cell" : "print:hidden"}`}>{formatNumber(total_height, 3)}</td>
