"""
Django settings for building_materials_store project.
...
ROOT_URLCONF = 'building_materials_store.urls'
...
WSGI_APPLICATION = 'building_materials_store.wsgi.application'
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_AFTER_ROTATION': True,                # заносить старые refresh токены в "чёрный список"
    'AUTH_HEADER_TYPES': ('Bearer',),                # тип токена в заголовке (Bearer)
}
