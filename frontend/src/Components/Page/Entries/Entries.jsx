      ...
      {({ values, handleChange, handleSubmit }) => (
        <form onSubmit={handleSubmit} className="space-y-4 max-w-lg mx-auto p-4 bg-white rounded shadow">
          <div>
            ...
            <input type="date" name="date" value={values.date} onChange={handleChange} className="border rounded px-3 py-2 w-full" />
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Дебет</label>
            <select name="debit_account" onChange={handleChange} value={values.debit_account} className="border rounded px-3 py-2 w-full">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Кредит</label>
            <select name="credit_account" onChange={handleChange} value={values.credit_account} className="border rounded px-3 py-2 w-full">
              <option value="">Выберите счёт</option>
              {accounts.map((acc) => (
                <option key={acc.id} value={acc.id}>
                  {acc.number} — {acc.name}
          ...
          <div>
            ...
            <input type="number" name="amount" onChange={handleChange} value={values.amount} className="border rounded px-3 py-2 w-full" />
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Комментарий</label>
            <input type="text" name="memo" onChange={handleChange} value={values.memo} className="border rounded px-3 py-2 w-full" />
          </div>
