  ...
  return (
    <tfoot className="bg-gray-50 dark:bg-gray-700">
      <tr>
        ...
        <td
          className={`px-3 py-2 border border-gray-300 dark:border-gray-600 ${visibleColumns.image ? "table-cell" : "hidden"} ${printVisibleColumns.image ? "print:table-cell" : "print:hidden"}`}
        ></td>
        <td
          className={`px-3 py-2 border border-gray-300 dark:border-gray-600 ${visibleColumns.qr_code ? "table-cell" : "hidden"} ${printVisibleColumns.qr_code ? "print:table-cell" : "print:hidden"}`}
        ></td>
        ...
        <td
          className={`px-3 py-2 border border-gray-300 dark:border-gray-600 ${visibleColumns.purchase ? "table-cell" : "hidden"} ${printVisibleColumns.purchase ? "print:table-cell" : "print:hidden"}`}
        ></td>
        <td
          className={`px-3 py-2 font-bold text-gray-900 dark:text-gray-100 text-right border border-gray-300 dark:border-gray-600 print:!text-black ${
        ...
        <td
          className={`px-3 py-2 border border-gray-300 dark:border-gray-600 ${visibleColumns.discount ? "table-cell" : "hidden"} ${printVisibleColumns.discount ? "print:table-cell" : "print:hidden"}`}
        ></td>
        <td
          className={`px-3 py-2 font-bold text-gray-900 dark:text-gray-100 text-right border border-gray-300 dark:border-gray-600 print:!text-black ${
        ...
        {!values.disabled && <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 print:hidden"></td>}
      </tr>
    </tfoot>
  );
};
